...
export const CommentText: React.FC<{ text: string }> = ({ text }) => {
    return (
...
export const AnswerCommentButton: React.FC = () => {
    return (
...
export const ShowMoreCommentsButton: React.FC = () => {
    return (
...
export const ShowLessCommentsButton: React.FC = () => {
    return (
        <button className='font-semibold text-[#171D1F] text-[15px] bg-none border-none mt-2'>
            Responder
        </button>
...
export const Comment: React.FC<CommentType> = ({ author, responses, text }) => {
